...
- `/task title` stores work that does not have a repository yet and includes it in daily reports.
- `/attach P-0001 owner/repo 1` links pending work to a repo and starts monitoring it.
